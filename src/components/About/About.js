        ...
        <div className={style.about}>
            ...
            <div className={style.text}>
                ...
                <div className={style.textBox}>
                    ...
                    For the same reason I chose Javascript I chose React (Vite.js), just because it is the most popular Javascript library
                    and I fell in love with it immediately. Along the way I learned how to use Nextjs, Typescript, REST-api's, git/github, Tailwind, css modules, Sass, MongoDB and some basic
                    knowledge on lots of stuff like Redux, Redux Toolkit, Express, Postman, Shadcn and MaterialUI. 
                    Photoshop for editing and optimizing images comes in handy as well, since it is hard to imagine a website without any images.<br /><br />
                    ...
                    there was a lot of magic going on. Now after 2 years I know there are no magicians at work but only very creative and clever people.
                    ...
                    <br /><br />
                    Noud van Dun<br />
                    <span>Amsterdam, April 6, 2021</span>
                </div>
