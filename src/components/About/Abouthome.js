        ...
        <div className={style.about}>
            ...
            <div className={style.textWrapper}>
                <div className={style.text}>
                    ...
                    foundation of making art and being an artist. Wrestling with the bare essence of oneself. The outcome
                    of the fight would soon be evident. No winner, no loser but a clear insight.<br />
                    <span className={style.fade1}>I decided to make a U-turn and retrain myself to become a so called self-taught web developer.</span><br /><br />
                    <span className={style.fade}>Coming from a artistic background, teaching yourself to code without any prior knowledge, without a mentor
                    is a time consuming enterprise with a relatively steep learning curve, depending on your background ofcourse.</span><br/>
                    <span className={style.fade2}>But the goal I set myself was clear, become a so called self-taught web developer.</span><br /><br />
